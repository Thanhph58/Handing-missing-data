...
e5_mi_05 <- read_excel("b4_mi_05.xlsx")
e5_mi_10 <- read_excel("b4_mi_10.xlsx")
e5_mi_15 <- read_excel("b4_mi_15.xlsx")
e5_mi_20 <- read_excel("b4_mi_20.xlsx")
e5_mi_25 <- read_excel("b4_mi_25.xlsx")
e5_mi_30 <- read_excel("b4_mi_30.xlsx")
...
######
# **** B2 - Merge the data -------------
e5_inci_merge <- rbind(e5_inci_raw, e5_inci_mi_05, e5_inci_mi_10, 
	e5_inci_mi_15, e5_inci_mi_20, e5_inci_mi_25, e5_inci_mi_30)

e5_inci_merge$type <- factor(e5_inci_merge$type, 
                        levels = c("raw", "5 per", "10 per", 
                        	"15 per", "20 per", "25 per", "30 per"))

######
# **** B5- Ve bieu do ----------
e5_inci_raw <- subset(e5_inci_raw, select = -type)
e5_inci_mi_05 <- subset(e5_inci_mi_05, select = -type)
e5_inci_mi_10 <- subset(e5_inci_mi_10, select = -type)
e5_inci_mi_15 <- subset(e5_inci_mi_15, select = -type)
e5_inci_mi_20 <- subset(e5_inci_mi_20, select = -type)
e5_inci_mi_25 <- subset(e5_inci_mi_25, select = -type)
e5_inci_mi_30 <- subset(e5_inci_mi_30, select = -type)


colnames(e5_inci_raw) <- c("on_set_day", "case_raw", "incidence_rate_raw")
colnames(e5_inci_mi_05) <- c("on_set_day", "case_05", "incidence_rate_05")
colnames(e5_inci_mi_10) <- c("on_set_day", "case_10", "incidence_rate_10")
colnames(e5_inci_mi_15) <- c("on_set_day", "case_15", "incidence_rate_15")
colnames(e5_inci_mi_20) <- c("on_set_day", "case_20", "incidence_rate_20")
colnames(e5_inci_mi_25) <- c("on_set_day", "case_25", "incidence_rate_25")
colnames(e5_inci_mi_30) <- c("on_set_day", "case_30", "incidence_rate_30")

e5_graph_inci_merge <- merge(e5_inci_raw, e5_inci_mi_05, by = "on_set_day", all.x = TRUE)
e5_graph_inci_merge <- merge(e5_graph_inci_merge, e5_inci_mi_10, by = "on_set_day", all.x = TRUE)
e5_graph_inci_merge <- merge(e5_graph_inci_merge, e5_inci_mi_15, by = "on_set_day", all.x = TRUE)
e5_graph_inci_merge <- merge(e5_graph_inci_merge, e5_inci_mi_20, by = "on_set_day", all.x = TRUE)
e5_graph_inci_merge <- merge(e5_graph_inci_merge, e5_inci_mi_25, by = "on_set_day", all.x = TRUE)
e5_graph_inci_merge <- merge(e5_graph_inci_merge, e5_inci_mi_30, by = "on_set_day", all.x = TRUE)

e5_graph_inci_merge$on_set_day <- as.Date(e5_graph_inci_merge$on_set_day )
...
# 30 Magenta: "magenta"
# ******** B5.1 - Raw vs 5% ---------
e5_graph_raw_05 <- ggplot(data = e5_graph_inci_merge, aes(x = on_set_day)) + 
...
#####
# ******** B5.2 - Raw vs 10% ---------
e5_graph_raw_10 <- ggplot(data = e5_graph_inci_merge, aes(x = on_set_day)) + 
  geom_line(aes(y = incidence_rate_raw, color = "Raw Data"), size = 1) +
...
#####
# ******** B5.3 - Raw vs 15% ---------
e5_graph_raw_15 <- ggplot(data = e5_graph_inci_merge, aes(x = on_set_day)) + 
  geom_line(aes(y = incidence_rate_raw, color = "Raw Data"), size = 1) +
...
#####
# ******** B5.4 - Raw vs 20% ---------
e5_graph_raw_20 <- ggplot(data = e5_graph_inci_merge, aes(x = on_set_day)) + 
  geom_line(aes(y = incidence_rate_raw, color = "Raw Data"), size = 1) +
...
#####
# ******** B5.5 - Raw vs 25% ---------
e5_graph_raw_25 <- ggplot(data = e5_graph_inci_merge, aes(x = on_set_day)) + 
  geom_line(aes(y = incidence_rate_raw, color = "Raw Data"), size = 1) +
...
#####
# ******** B5.6 - Raw vs 30% ---------
e5_graph_raw_30 <- ggplot(data = e5_graph_inci_merge, aes(x = on_set_day)) + 
  geom_line(aes(y = incidence_rate_raw, color = "Raw Data"), size = 1) +
...
e5_plot_list_1 <- list(e5_graph_raw_05, e5_graph_raw_10, e5_graph_raw_15)

e5_plot_list_2 <- list(e5_graph_raw_20, e5_graph_raw_25, e5_graph_raw_30)

# Arrange the plots 
e5_combined_plot_0515 <- grid.arrange(
  grobs = e5_plot_list_1,
  ncol = 1  # Adjust the number of columns here if needed
)

# Explore the plot
ggsave(
	filename = "e5_1_combined_plot_0515.PNG", 
  plot = e5_combined_plot_0515, 
  width = 9, height = 6, 
  units = "in", dpi = 600)

# Arrange the plots 
e5_combined_plot_2030 <- grid.arrange(
  grobs = e5_plot_list_2,
  ncol = 1  # Adjust the number of columns here if needed
)

# Explore the plot
ggsave(
	filename = "e5_2_combined_plot_2030.PNG", 
  plot = e5_combined_plot_2030, 
  width = 9, height = 6, 
  units = "in", dpi = 600)
...
e5_raw_sum_cycle <- e5_raw_sum_lag %>%
...
e5_raw_sum_ccc_indexes <- e5_raw_sum_cycle %>%
    # Tinh ccc count
    group_by(commune) %>%
...
e5_raw_ccc_indexes <- e5_raw_sum_ccc_indexes %>%
...
e5_mi_05_sum_cycle <- e5_mi_05_sum_lag %>%
    # Xac dinh cac su kien
    arrange(commune) %>%
    mutate(event = case_when(
        # Dich
...
e5_mi_05_sum_ccc_indexes <- e5_mi_05_sum_cycle %>%
    # Tinh ccc count
    group_by(commune) %>%
    mutate(ccc_count = rleid(commune, start_time, end_time)) %>%
	# Tinh ccc time
...
e5_mi_05_ccc_indexes <- e5_mi_05_sum_ccc_indexes %>%
  # Calculate the maximum ccc_count for each commune
  group_by(commune) %>%
...
e5_mi_10_sum_cycle <- e5_mi_10_sum_lag %>%
    # Xac dinh cac su kien
    arrange(commune) %>%
    mutate(event = case_when(
        # Dich
...
e5_mi_10_sum_ccc_indexes <- e5_mi_10_sum_cycle %>%
    # Tinh ccc count
    group_by(commune) %>%
    mutate(ccc_count = rleid(commune, start_time, end_time)) %>%
	# Tinh ccc time
...
e5_mi_10_ccc_indexes <- e5_mi_10_sum_ccc_indexes %>%
  # Calculate the maximum ccc_count for each commune
  group_by(commune) %>%
...
e5_mi_15_sum_cycle <- e5_mi_15_sum_lag %>%
    # Xac dinh cac su kien
    arrange(commune) %>%
    mutate(event = case_when(
        # Dich
...
e5_mi_15_sum_ccc_indexes <- e5_mi_15_sum_cycle %>%
    # Tinh ccc count
    group_by(commune) %>%
    mutate(ccc_count = rleid(commune, start_time, end_time)) %>%
	# Tinh ccc time
...
e5_mi_15_ccc_indexes <- e5_mi_15_sum_ccc_indexes %>%
  # Calculate the maximum ccc_count for each commune
  group_by(commune) %>%
...
e5_mi_20_sum_cycle <- e5_mi_20_sum_lag %>%
    # Xac dinh cac su kien
    arrange(commune) %>%
    mutate(event = case_when(
        # Dich
...
e5_mi_20_sum_ccc_indexes <- e5_mi_20_sum_cycle %>%
    # Tinh ccc count
    group_by(commune) %>%
    mutate(ccc_count = rleid(commune, start_time, end_time)) %>%
	# Tinh ccc time
...
e5_mi_20_ccc_indexes <- e5_mi_20_sum_ccc_indexes %>%
  # Calculate the maximum ccc_count for each commune
  group_by(commune) %>%
...
e5_mi_25_sum_cycle <- e5_mi_25_sum_lag %>%
    # Xac dinh cac su kien
    arrange(commune) %>%
    mutate(event = case_when(
        # Dich
...
e5_mi_25_sum_ccc_indexes <- e5_mi_25_sum_cycle %>%
    # Tinh ccc count
    group_by(commune) %>%
    mutate(ccc_count = rleid(commune, start_time, end_time)) %>%
	# Tinh ccc time
...
e5_mi_25_ccc_indexes <- e5_mi_25_sum_ccc_indexes %>%
  # Calculate the maximum ccc_count for each commune
  group_by(commune) %>%
...
e5_mi_30_sum_cycle <- e5_mi_30_sum_lag %>%
    # Xac dinh cac su kien
    arrange(commune) %>%
    mutate(event = case_when(
        # Dich
...
e5_mi_30_sum_ccc_indexes <- e5_mi_30_sum_cycle %>%
    # Tinh ccc count
    group_by(commune) %>%
    mutate(ccc_count = rleid(commune, start_time, end_time)) %>%
	# Tinh ccc time
...
e5_mi_30_ccc_indexes <- e5_mi_30_sum_ccc_indexes %>%
  # Calculate the maximum ccc_count for each commune
  group_by(commune) %>%
...
# **** C8 - Merge data -------------
######
e5_merge <- merge(e5_raw_ccc_indexes, e5_mi_05_ccc_indexes, by = "commune", all.x = TRUE)
e5_merge <- merge(e5_merge, e5_mi_10_ccc_indexes, by = "commune", all.x = TRUE)
e5_merge <- merge(e5_merge, e5_mi_15_ccc_indexes, by = "commune", all.x = TRUE)
e5_merge <- merge(e5_merge, e5_mi_20_ccc_indexes, by = "commune", all.x = TRUE)
e5_merge <- merge(e5_merge, e5_mi_25_ccc_indexes, by = "commune", all.x = TRUE)
e5_merge <- merge(e5_merge, e5_mi_30_ccc_indexes, by = "commune", all.x = TRUE)

e5_merge[is.na(e5_merge)] <- 0
...
e5_mi_05_1 <- e5_mi_05_1[, -which(names(e5_mi_05_1) == "period")]
e5_mi_10_1 <- e5_mi_10_1[, -which(names(e5_mi_10_1) == "period")]
e5_mi_15_1 <- e5_mi_15_1[, -which(names(e5_mi_15_1) == "period")]
e5_mi_20_1 <- e5_mi_20_1[, -which(names(e5_mi_20_1) == "period")]
e5_mi_25_1 <- e5_mi_25_1[, -which(names(e5_mi_25_1) == "period")]
e5_mi_30_1 <- e5_mi_30_1[, -which(names(e5_mi_30_1) == "period")]

# Rename the colummns
colnames(b1_raw_1) <- c("on_set_day", "commune", "case_raw")
colnames(e5_mi_05_1) <- c("on_set_day", "commune", "case_mi_05", "note_mi_05")
colnames(e5_mi_10_1) <- c("on_set_day", "commune", "case_mi_10", "note_mi_10")
colnames(e5_mi_15_1) <- c("on_set_day", "commune", "case_mi_15", "note_mi_15")
colnames(e5_mi_20_1) <- c("on_set_day", "commune", "case_mi_20", "note_mi_20")
colnames(e5_mi_25_1) <- c("on_set_day", "commune", "case_mi_25", "note_mi_25")
colnames(e5_mi_30_1) <- c("on_set_day", "commune", "case_mi_30", "note_mi_30")

# Merge the data
e5_crude_merge <- merge(b1_raw_1, e5_mi_05_1, by = c("on_set_day", "commune"), all=TRUE)
e5_crude_merge <- merge(e5_crude_merge, e5_mi_10_1, by = c("on_set_day", "commune"), all=TRUE)
e5_crude_merge <- merge(e5_crude_merge, e5_mi_15_1, by = c("on_set_day", "commune"), all=TRUE)
e5_crude_merge <- merge(e5_crude_merge, e5_mi_20_1, by = c("on_set_day", "commune"), all=TRUE)
e5_crude_merge <- merge(e5_crude_merge, e5_mi_25_1, by = c("on_set_day", "commune"), all=TRUE)
e5_crude_merge <- merge(e5_crude_merge, e5_mi_30_1, by = c("on_set_day", "commune"), all=TRUE)

######
# **** E2 Calculate the change **** --------
colnames(e5_crude_merge)
# 5 per
e5_crude_merge_05 <- e5_crude_merge %>%
	filter(note_mi_05 == "miss") %>%
	mutate(change_05 = case_raw - case_mi_05) 

e5_crude_05 <- e5_crude_merge_05 %>%
  summarise(
...
# 10 per
e5_crude_merge_10 <- e5_crude_merge %>%
	filter(note_mi_10 == "miss") %>%
	mutate(change_10 = case_raw - case_mi_10) 

e5_crude_10 <- e5_crude_merge_10 %>%
  summarise(
...
# 15 per
e5_crude_merge_15 <- e5_crude_merge %>%
	filter(note_mi_15 == "miss") %>%
	mutate(change_15 = case_raw - case_mi_15) 

e5_crude_15 <- e5_crude_merge_15 %>%
  summarise(
...
# 20 per
e5_crude_merge_20 <- e5_crude_merge %>%
	filter(note_mi_20 == "miss") %>%
	mutate(change_20 = case_raw - case_mi_20)

e5_crude_20 <- e5_crude_merge_20 %>%
  summarise(
...
# 25 per
e5_crude_merge_25 <- e5_crude_merge %>%
	filter(note_mi_25 == "miss") %>%
	mutate(change_25 = case_raw - case_mi_25)

e5_crude_25 <- e5_crude_merge_25 %>%
  summarise(
...
# 30 per
e5_crude_merge_30 <- e5_crude_merge %>%
	filter(note_mi_30 == "miss") %>%
	mutate(change_30 = case_raw - case_mi_30)

e5_crude_30 <- e5_crude_merge_30 %>%
  summarise(
...
# Merge all
e5_crude_all <- rbind(e5_crude_05, e5_crude_10,
	e5_crude_15, e5_crude_20,
	e5_crude_25, e5_crude_30)

e5_crude_all$method <- "5-linear"

library(writexl)

write_xlsx(e5_crude_all,"e5_crude_all.xlsx")

######
# **** D3 -Percentage change in incidence rate ----------------
# Replace missing value

e5_graph_inci_merge <- replace(e5_graph_inci_merge, is.na(e5_graph_inci_merge), 0)

colnames(e5_graph_inci_merge)

e5_merge_ch_inci_05 <- e5_graph_inci_merge %>%
...
e5_merge_ch_inci_10 <- e5_graph_inci_merge %>%
...
e5_merge_ch_inci_15 <- e5_graph_inci_merge %>%
...
e5_merge_ch_inci_20 <- e5_graph_inci_merge %>%
...
e5_merge_ch_inci_25 <- e5_graph_inci_merge %>%
...
e5_merge_ch_inci_30 <- e5_graph_inci_merge %>%
...
e5_merge_ch_inci_sum <- rbind(e5_merge_ch_inci_05, e5_merge_ch_inci_10,
	e5_merge_ch_inci_15, e5_merge_ch_inci_20,
	e5_merge_ch_inci_25, e5_merge_ch_inci_30)

e5_merge_ch_inci_sum$method <- "5-linear"

library(writexl)

write_xlsx(e5_merge_ch_inci_sum,"e5_ch_inci.xlsx")