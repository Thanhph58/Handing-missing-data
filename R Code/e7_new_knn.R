...
e7_mi_05 <- read_excel("b4_mi_05.xlsx")
e7_mi_10 <- read_excel("b4_mi_10.xlsx")
e7_mi_15 <- read_excel("b4_mi_15.xlsx")
e7_mi_20 <- read_excel("b4_mi_20.xlsx")
e7_mi_25 <- read_excel("b4_mi_25.xlsx")
e7_mi_30 <- read_excel("b4_mi_30.xlsx")
...
######
# **** B2 - Merge the data -------------
e7_inci_merge <- rbind(e7_inci_raw, e7_inci_mi_05, e7_inci_mi_10, 
	e7_inci_mi_15, e7_inci_mi_20, e7_inci_mi_25, e7_inci_mi_30)

e7_inci_merge$type <- factor(e7_inci_merge$type, 
                        levels = c("raw", "5 per", "10 per", 
                        	"15 per", "20 per", "25 per", "30 per"))

######
# **** B5- Ve bieu do ----------
e7_inci_raw <- subset(e7_inci_raw, select = -type)
e7_inci_mi_05 <- subset(e7_inci_mi_05, select = -type)
e7_inci_mi_10 <- subset(e7_inci_mi_10, select = -type)
e7_inci_mi_15 <- subset(e7_inci_mi_15, select = -type)
e7_inci_mi_20 <- subset(e7_inci_mi_20, select = -type)
e7_inci_mi_25 <- subset(e7_inci_mi_25, select = -type)
e7_inci_mi_30 <- subset(e7_inci_mi_30, select = -type)


colnames(e7_inci_raw) <- c("on_set_day", "case_raw", "incidence_rate_raw")
colnames(e7_inci_mi_05) <- c("on_set_day", "case_05", "incidence_rate_05")
colnames(e7_inci_mi_10) <- c("on_set_day", "case_10", "incidence_rate_10")
colnames(e7_inci_mi_15) <- c("on_set_day", "case_15", "incidence_rate_15")
colnames(e7_inci_mi_20) <- c("on_set_day", "case_20", "incidence_rate_20")
colnames(e7_inci_mi_25) <- c("on_set_day", "case_25", "incidence_rate_25")
colnames(e7_inci_mi_30) <- c("on_set_day", "case_30", "incidence_rate_30")

e7_graph_inci_merge <- merge(e7_inci_raw, e7_inci_mi_05, by = "on_set_day", all.x = TRUE)
e7_graph_inci_merge <- merge(e7_graph_inci_merge, e7_inci_mi_10, by = "on_set_day", all.x = TRUE)
e7_graph_inci_merge <- merge(e7_graph_inci_merge, e7_inci_mi_15, by = "on_set_day", all.x = TRUE)
e7_graph_inci_merge <- merge(e7_graph_inci_merge, e7_inci_mi_20, by = "on_set_day", all.x = TRUE)
e7_graph_inci_merge <- merge(e7_graph_inci_merge, e7_inci_mi_25, by = "on_set_day", all.x = TRUE)
e7_graph_inci_merge <- merge(e7_graph_inci_merge, e7_inci_mi_30, by = "on_set_day", all.x = TRUE)

e7_graph_inci_merge$on_set_day <- as.Date(e7_graph_inci_merge$on_set_day )
...
# 30 Magenta: "magenta"
# ******** B5.1 - Raw vs 5% ---------
e7_graph_raw_05 <- ggplot(data = e7_graph_inci_merge, aes(x = on_set_day)) + 
...
#####
# ******** B5.2 - Raw vs 10% ---------
e7_graph_raw_10 <- ggplot(data = e7_graph_inci_merge, aes(x = on_set_day)) + 
  geom_line(aes(y = incidence_rate_raw, color = "Raw Data"), size = 1) +
...
#####
# ******** B5.3 - Raw vs 15% ---------
e7_graph_raw_15 <- ggplot(data = e7_graph_inci_merge, aes(x = on_set_day)) + 
  geom_line(aes(y = incidence_rate_raw, color = "Raw Data"), size = 1) +
...
#####
# ******** B5.4 - Raw vs 20% ---------
e7_graph_raw_20 <- ggplot(data = e7_graph_inci_merge, aes(x = on_set_day)) + 
  geom_line(aes(y = incidence_rate_raw, color = "Raw Data"), size = 1) +
...
#####
# ******** B5.5 - Raw vs 25% ---------
e7_graph_raw_25 <- ggplot(data = e7_graph_inci_merge, aes(x = on_set_day)) + 
  geom_line(aes(y = incidence_rate_raw, color = "Raw Data"), size = 1) +
...
#####
# ******** B5.6 - Raw vs 30% ---------
e7_graph_raw_30 <- ggplot(data = e7_graph_inci_merge, aes(x = on_set_day)) + 
  geom_line(aes(y = incidence_rate_raw, color = "Raw Data"), size = 1) +
...
e7_plot_list_1 <- list(e7_graph_raw_05, e7_graph_raw_10, e7_graph_raw_15)

e7_plot_list_2 <- list(e7_graph_raw_20, e7_graph_raw_25, e7_graph_raw_30)

# Arrange the plots 
e7_combined_plot_0515 <- grid.arrange(
  grobs = e7_plot_list_1,
  ncol = 1  # Adjust the number of columns here if needed
)

# Explore the plot
ggsave(
	filename = "e7_1_combined_plot_0515.PNG", 
  plot = e7_combined_plot_0515, 
  width = 9, height = 6, 
  units = "in", dpi = 600)

# Arrange the plots 
e7_combined_plot_2030 <- grid.arrange(
  grobs = e7_plot_list_2,
  ncol = 1  # Adjust the number of columns here if needed
)

# Explore the plot
ggsave(
	filename = "e7_2_combined_plot_2030.PNG", 
  plot = e7_combined_plot_2030, 
  width = 9, height = 6, 
  units = "in", dpi = 600)
...
e7_raw_sum_cycle <- e7_raw_sum_lag %>%
...
e7_raw_sum_ccc_indexes <- e7_raw_sum_cycle %>%
    # Tinh ccc count
    group_by(commune) %>%
...
e7_raw_ccc_indexes <- e7_raw_sum_ccc_indexes %>%
...
e7_mi_05_sum_cycle <- e7_mi_05_sum_lag %>%
    # Xac dinh cac su kien
    arrange(commune) %>%
    mutate(event = case_when(
        # Dich
...
e7_mi_05_sum_ccc_indexes <- e7_mi_05_sum_cycle %>%
    # Tinh ccc count
    group_by(commune) %>%
    mutate(ccc_count = rleid(commune, start_time, end_time)) %>%
	# Tinh ccc time
...
e7_mi_05_ccc_indexes <- e7_mi_05_sum_ccc_indexes %>%
  # Calculate the maximum ccc_count for each commune
  group_by(commune) %>%
...
e7_mi_10_sum_cycle <- e7_mi_10_sum_lag %>%
    # Xac dinh cac su kien
    arrange(commune) %>%
    mutate(event = case_when(
        # Dich
...
e7_mi_10_sum_ccc_indexes <- e7_mi_10_sum_cycle %>%
    # Tinh ccc count
    group_by(commune) %>%
    mutate(ccc_count = rleid(commune, start_time, end_time)) %>%
	# Tinh ccc time
...
e7_mi_10_ccc_indexes <- e7_mi_10_sum_ccc_indexes %>%
  # Calculate the maximum ccc_count for each commune
  group_by(commune) %>%
...
e7_mi_15_sum_cycle <- e7_mi_15_sum_lag %>%
    # Xac dinh cac su kien
    arrange(commune) %>%
    mutate(event = case_when(
        # Dich
...
e7_mi_15_sum_ccc_indexes <- e7_mi_15_sum_cycle %>%
    # Tinh ccc count
    group_by(commune) %>%
    mutate(ccc_count = rleid(commune, start_time, end_time)) %>%
	# Tinh ccc time
...
e7_mi_15_ccc_indexes <- e7_mi_15_sum_ccc_indexes %>%
  # Calculate the maximum ccc_count for each commune
  group_by(commune) %>%
...
e7_mi_20_sum_cycle <- e7_mi_20_sum_lag %>%
    # Xac dinh cac su kien
    arrange(commune) %>%
    mutate(event = case_when(
        # Dich
